...
if [ ! -f "yolov5s.hef" ] && [ ! -f "ssd_mobilenet_v2_coco.hef" ]; then
    ...
    if [ $DETECTION_DOWNLOADED -eq 0 ]; then
        echo ""
        echo "=========================================="
        echo "ERROR: Failed to obtain detection model"
        echo "=========================================="
        echo ""
        echo "RECOMMENDED SOLUTION: Use Hailo Model Zoo workflow"
        echo ""
        echo "The Hailo Model Zoo is the centralized repository for models."
        echo "Best practice is to use the 'hailomz' tool to compile models."
        echo ""
        echo "Option 1: Install and use hailomz (RECOMMENDED)"
        echo "  1. Ensure Hailo SDK is fully installed:"
        echo "     sudo apt-get install hailo-all"
        echo ""
        echo "  2. Install Hailo Model Zoo:"
        echo "     git clone $HAILO_MODEL_ZOO_REPO"
        echo "     cd hailo_model_zoo"
        echo "     pip install -e ."
        echo ""
        echo "  3. Compile models using hailomz:"
        echo "     hailomz compile yolov5s --target hailo8l"
        echo "     # Or for SSD MobileNet v2:"
        echo "     hailomz compile ssd_mobilenet_v2 --target hailo8l"
        echo ""
        echo "  4. Copy compiled HEF files to all_models/ directory"
        echo ""
        echo "Option 2: Check Raspberry Pi AI Kit documentation"
        echo "  The official guide may have pre-compiled models:"
        echo "  https://www.raspberrypi.com/documentation/accessories/ai-kit.html"
        echo ""
        echo "Option 3: Use Hailo Model Explorer"
        echo "  Find and download suitable models:"
        echo "  https://hailo.ai/de/products/hailo-software/model-explorer-vision/"
        echo ""
        echo "Option 4: Convert TFLite models (if you have Hailo DFC)"
        ...
        echo "Please obtain a model using one of the methods above."
        echo ""
